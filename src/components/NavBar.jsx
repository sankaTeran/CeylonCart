  ...
  return (
    <nav className="flex items-center justify-between px-6 md:px-16 lg:px-24 xl:px-32 py-4 border-b border-gray-300 bg-white relative transition-all">
            ...
            <NavLink to={'/'} onClick={()=>setOpen(false)}>
                <img className='h-15' src={assets.logo} alt="" />
            </NavLink>
            ...
            <div className="hidden sm:flex items-center gap-8">
                ...
                <div className='relative group'>
                    ...
                    <ul className='hidden group-hover:block absolute top-10 right-0 bg-white shadow border border-gray-200 scroll-py-2.5 w-30 rounded-md text-sm z-40'>
            ...
            {open && (
                ...
                <NavLink to='/' onClick={()=>setOpen(false)}>Contacts</NavLink>
